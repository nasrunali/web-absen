...
if(isset($_POST['submit'])){
    ...
    if(!is_numeric($nis)){
        ...
        // Query SQL
        $sql = "INSERT INTO `tb_siswa`(`id`, `nama_siswa`, `nis`, `tingkat`, `jurusan`, `kelas`)
                VALUES (NULL, '$nama_siswa', '$nis', '$tingkat', '$jurusan', '$kelas')";
        ...
        if($result) {
            header("location: tambahsiswa.php?msg=new record created successfully");
            exit();
        } else {
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="post">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="tingkat" placeholder="Masukan Tingkat">
                                </div>
                                <div>
                                ...
                                <button type="submit" class="btn btn-primary mt-3" name="submit">Kirim</button>
